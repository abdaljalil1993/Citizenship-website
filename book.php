...
<div class="container-fluid top-bar" >
    ...
    <ul class="social">
      ...
      <li><a href="https://www.facebook.com/Citizenships-104622184526249"><i style="color:#D69B25;font-size: 20px; " class=" fab fa-facebook"></i></a></li>
      <li><a href="https://www.twitter.com/Citizenshipsae"><i style="color:#D69B25;font-size: 20px; " class=" fab fa-twitter"></i></a></li>
      
      <li><a href="https://www.instagram.com/Citizenships.ae"><i style="color:#D69B25;font-size: 20px; " class=" fab fa-instagram"></i></a></li>
    </ul>
...
<div class="text-center" style="margin: 50px auto;">
  <h1 class="text-warning">Book Free Consultation</h1>
...
<div class="container" >
  <div class="row">
    ...
    <h3 class="text-warning">Fill the Form Below To Book a Free Consultation</h3> 
    <hr>
   <form action="book.php" method="post" >
      <input type="text" placeholder="name" class="form-control" name="n"> <br>

 <input type="text" placeholder="phone" class="form-control" name="ph"> <br>

  <input type="text" placeholder="short consultation description" class="form-control" name="de"> <br>

  <input type="text" placeholder="your email" class="form-control" name="e"> <br>
<label>Prefer Date</label>
  <input type="date" class="form-control" name="dt"> <br>
     <input type="submit" name="btn" class="btn btn-warning btn-lg" value="Send Request"><br>
   </form>
    </div>
    </div>
...
$r=mysqli_query($con,"insert into consult(name,phone,description,dt,email)
  values('$name','$phone','$des','$dt','$email')");
...
//bactnotes@bacttraining.com,bact@bact.ae,tr5@bacttraining.com,tr6@bacttraining.com

$to = "debowfadi@gmail.com";
$subject = "Booking a Free Consultation By ".$name;

$headers = "From: Free Consultation" . "\r\n" .
