...
.vv{
	background-color:rgba(255,255,255,0.97);border-radius: 10px;padding: 10px;height: 190px;word-wrap: break-word;border:1px solid #D69B25; overflow: hidden;
	width: 31%;
	margin-right: 5px;
}
...
<div style="background-color:rgba(10,54,108,0.2);width: 100%">
  ...
  <a class="navbar-brand" href="#" style="color: #E7E7E8; font-size: 23px;"> <img src="images/logo1.png" alt="citizenships logo" style="width: 160px;height: 100px;"> CitizenShips</a>
  ...
  <div class="carousel-inner" >
    <div class="carousel-item active">
     ...
     <div class="text-center" >
       <img alt="citizenships logo" src="images/logo1.png" style="width: 420px;height: 330px;">
       <br>
    ...
    <div class="carousel-item">
     ...
     <div class="text-center" >
     <img alt="citizenships logo" src="images/logo1.png" style="width: 300px;height: 280px;">
       <br>
